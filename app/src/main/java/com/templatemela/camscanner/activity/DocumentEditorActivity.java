...
//        WatermarkBuilder.create(getApplicationContext(), iv_editImg.getSource()).loadWatermarkText(new WatermarkText("123").setPositionX(2.0d).setPositionY(2.0d).setTextFont(2131296286).setTextColor(-16777216).setTextAlpha(255).setRotation(-30.0d).setTextSize(20.0d)).setTileMode(true).getWatermark().setToImageView(iv_editImg.getSource());
        Bitmap icon = BitmapFactory.decodeResource(getResources(),
                R.drawable.checkim);

        WatermarkBuilder.create(getApplicationContext(), iv_editImg.getSource()).loadWatermarkImage(new WatermarkImage(icon).setImageAlpha(255)).getWatermark().setToImageView(iv_editImg.getSource());
        ...
        switch (id) {
            ...
            case R.id.iv_apply_watermark:
                ...
                if (et_watermark_txt.getText().toString().length() > 0) {
                    ...
                    Log.i(TAG, "onClick: "+et_watermark_txt.getCurrentTextColor()+" "+sb_watermark_opacity.getProgress()+" "+watermarkFont);
