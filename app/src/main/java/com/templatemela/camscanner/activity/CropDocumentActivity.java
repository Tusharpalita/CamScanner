...
public class CropDocumentActivity extends BaseActivity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private void init() {
        ...
        iv_preview_crop.setImageBitmap(icon);
     //   WatermarkBuilder.create(getApplicationContext(), iv_preview_crop.getBitmap()).loadWatermarkImage(new WatermarkImage(icon).setImageAlpha(255)).getWatermark().setToImageView(iv_preview_crop);
